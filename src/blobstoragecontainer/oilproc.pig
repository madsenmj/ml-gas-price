...
input1 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/input_1_20140601/' USING PigStorage(',') 
...
input2 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/input_2_20140601/' USING PigStorage(',') 
--input2 = LOAD 'input_2.txt' using PigStorage(',')
 as (labela:chararray, labelb:chararray, datestr:chararray, freq, value2:int, unit);
input3 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/input_3_20140601/' USING PigStorage(',') 
--input3 = LOAD 'input_3.txt' using PigStorage(',')
 as (labela:chararray, labelb:chararray, datestr:chararray, freq, value3:float, unit);
input4 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/input_4_20140601/' USING PigStorage(',') 
--input4 = LOAD 'input_4.txt' using PigStorage(',')
 as (labela:chararray, labelb:chararray, datestr:chararray, freq, value4:int, unit);
input5 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/input_5_20140601/' USING PigStorage(',') 
...
input7 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/input_7_20140601/' USING PigStorage(',') 
--input7 = LOAD 'input_7.txt' using PigStorage(',')
 as (labela:chararray, labelb:chararray, datestr:chararray, freq, value7:int, unit);
input8 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/input_8_20140601/' USING PigStorage(',') 
...
input0 = LOAD 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/price_0_20140601/' using PigStorage(',')
...
STORE trainfeatures into 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/trainfeatures.txt' USING PigStorage (',');
STORE testfeatures into 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/testfeatures.txt' USING PigStorage (',');
STORE trainvalues into 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/trainvalues.txt' USING PigStorage (',');
STORE testvalues into 'wasb://blobstoragecontainer@blobstorageaccount.blob.core.windows.net/testvalues.txt' USING PigStorage (',');
